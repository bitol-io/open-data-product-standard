...
| managementPorts[].deprecated               | boolean | Deprecated                | No       | Indicates this management port is deprecated and should not be used in new implementations. Defaults to false. See [Deprecated](deprecated.md). (Added in v1.1.0.) |
