...
| outputPorts.version                  |     | Version                   | No       | For each version, a different instance of the output port is listed. The combination of the name and version is the key. A new (major) version would be a new output port, for simplicity. Version of the data contract associated to this output port, becomes the version of the output port.                                                                                       |
