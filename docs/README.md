...
| inputPorts.**name**                  | Yes | Name                      | Yes      | Name of the input port.                                                                                                                                                                    |
| inputPorts.**version**               | Yes | Version                   | Yes      | Version of the referenced data contract. The combination of `name` and `version` is the key of the input port.                                                                             |
| inputPorts.**contractId**            | Yes | Contract Id               | Yes      | Identifier of the data contract this input port references. An input port without a contract reference has no meaning.                                                                    |
